...
[dummy, iA, iB] = intersect(A.var, B.var);    % iA: indexes of the common elements in A. iB: indexes of those in B. dummy contains the common elements that are sorted.
if ~isempty(dummy)
...
C.var = union(A.var, B.var);           % note that C.var is sorted
